...
*Généré automatiquement à partir de `content/sessions/GIS805-05.yaml`. Pour corriger une coquille, modifiez le YAML source et poussez sur `master` — la CI régénère PDF + Markdown.*
